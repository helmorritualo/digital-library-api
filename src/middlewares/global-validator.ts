...
// Main validator middleware factory
export const validator = <T extends z.ZodSchema>(target: ValidationTarget, schema: T) => {
...
export const validateParam = <T extends z.ZodSchema>(schema: T) => validator("param", schema);
